...
def add():
    ...
    dept=d1.get()
    emp_salary=s1.get()
    if emp_id=='' or emp_name=='' or dept=='' or emp_salary=='':
        messagebox.showinfo('info','All fields are compulsory')
    else:
        conn=pymysql.connect(user='root',host='localhost',password='Shruti@2903',database='emp_project')
...
l0=Label(win,text='EMPLOYEE MANAGEMENT SYSTEM',width=40,bg='white',fg='black',bd=5,relief='ridge',font=('times new roman',18,'bold'))
